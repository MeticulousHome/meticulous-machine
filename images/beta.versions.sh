...
export BACKEND_REV="26d8dcb64917e1641af5dacf3d2293538f19f42d" # api/settings: allow usage of the settings endpoint without trailing /
...
export HISTORY_UI_REV="cfbe0c48dc11759cc800b4e73bcdea363f9c9021" # feat(weightThreshold)
