...
export BACKEND_REV="be5a862589679a17afcc9583e5aac9e41ffc1c8d" # chore(timezoneManager): add subrpocess stderr and stdout to raised exception for a better
export DIAL_REV="2c619613398a7f5a57741bcebd13f9770050d981" # chore(release): v1.96.2 [skip ci]
...
export FIRMWARE_REV="a1fdefa5b860da4a2fe8509c5f39c82573ec27aa" # fix: motor disabled on purge and home
...
export CRASH_REPORTER_REV="d620f70dc6633803b52de8bfdc3a8888a41e24db" # add report to self-hosted sentry
