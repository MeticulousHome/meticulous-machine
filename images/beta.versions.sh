...
export BACKEND_REV="f2aa51d6102a5dac617362c7ac2503ce1eef85ff" # fix: also save machine data in debug file when purging and homing
export DIAL_REV="9ba5f71d4252eb489f129b38f471045665135133" # chore(release): v1.93.0 [skip ci]
...
export FIRMWARE_REV="9ccf649cac97487ef36351b6a3adeeb6a88fb1bd" # feat: tare button no longers perform tare action
