...
export BACKEND_REV="d693ddd000301b41bbf9ea21834d2b06108342a4" # Fix syntax error in error logging for volume setting
export DIAL_REV="f638a415bd84478d6c2cb6e64c3ddeae6253d574" # chore(release): v1.96.0 [skip ci]
...
export FIRMWARE_REV="4c54404037491d48ef435f075bb21e0f9cc577ff" # sensors/predicted_weight: hardcode partial retraction values
