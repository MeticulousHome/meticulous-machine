...
export BACKEND_REV="2790ba6cc3c915e3a1feea129ef7edaa2b3aa45f" # Sync auto purge setting to firmware
export DIAL_REV="cc19acb3813b00f2ca9ca7431e89ffb3d630d62c" # chore(release): v1.102.7 [skip ci]
...
export FIRMWARE_REV="ba71fd6c049b80830479286e220b9e4fe5f49dba" # Merge pull request #478 from MeticulousHome/codex/auto-purge-config-firmware
