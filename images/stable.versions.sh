...
export BACKEND_REV="d244ce944bdf9cb3c50ce9b93cec4dc774b53e2d" # shot-manager: fix setpoints not storing
export DIAL_REV="5d6a9bf38d4ac744eed19938faf7d26ad3555a42" # chore(release): v1.60.1 [skip ci]
