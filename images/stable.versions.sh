...
export BACKEND_REV="a843576a8fd49bdd157be58067870b026b00ab80" # wifi: add support for wpa3
export DIAL_BRANCH="stable"
export DIAL_REV="6aadb620e5417bf7109bf57125cb8efe2d230b2e" # chore(release): v1.101.1 [skip ci]
...
export FIRMWARE_REV="bf9e34b9a6df55aa2f28f1df9b82cf35d2f5c666" # Revert to the last stable state
